...
root_folder = 'D:\\Nadax\\Github\\proyecto2018\\pedestrian\\INRIA\\'
folder_pos_to = 'D:\\Nadax\\Github\\proyecto2018\\pedestrian\\INRIA\\final\\pos\\'
folder_neg_to = 'D:\\Nadax\\Github\\proyecto2018\\pedestrian\\INRIA\\final\\neg\\'
final_size = [96, 48]
...
def get_bounding_boxes(file_path):
    ...
    bounding_boxes_file = codecs.open(root_folder + file_path, "r", "ISO-8859-1")
...
def resize(img):
    """Devuelve la imagen con el tamanio modificado"""
...
def load_pos():
    ...
    for img_path, bounding_boxes_path in zip(content_pos.readlines(), content_annotations.readlines()):
        ...
        bounding_boxes_path = bounding_boxes_path.replace("/", "\\")
...
def load_neg():
    ...
    content_neg = open(root_folder + 'Train\\neg.lst')  # Abro el listado de imagenes positivas
