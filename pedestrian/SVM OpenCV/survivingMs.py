...
def main():
    ...
    while(c>0):   
        ...
        oldRect = survivingBBoxes_ms(oldRect, newRect, settings.trackThreshold, frameTime)  
...
def HogDescriptor(image,hog):
    ...
    if len(rects):
        return np.pad(rects,((0,0),(0,1)), 'constant', constant_values=(settings.boundBoxLife))
    else:        
        return rects
