...
def NormalizeImage(image, maxValue=False):#Normaliza la imagen entre 0 y maxValue o 255
    isFloat = type(image[0][0]) is float and image[0][0] < 1 #Me fijo si la imagen esta normalizada entre 0 y 1, tomando el primer pixel
...
#------------------TRATAMIENTO DE HOGS----------------------
def HogFromImage(image, grayscale=False, resize=False, finalSize=None, normalize=True, maxValue=False, printHogs=False): #Devuelve el HOG de una imagen
...
def GetHogsFromPath(pathToFolder, grayscale=False, resize=False, finalSize=None, subset=-1, normalize=True, maxValue=False, printImages=False, printHogs=False):
    ...
    return hogs
def GetHogsFromList(images, grayscale=False, resize=False, finalSize=None, subset=-1, normalize=True, maxValue=False, printImages=False,printHogs=False):
    hogs = []
    i = 0
